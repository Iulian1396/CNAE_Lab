...
- {id: FLASH_CLK.outFreq, value: 80/3 MHz}
...
- {id: LPSPI0_CLK.outFreq, value: 40 MHz}
...
- {id: SOSCDIV2_CLK.outFreq, value: 4 MHz}
...
settings:
- {id: CLKOUTEnable, value: Disabled}
- {id: CMP0_CGC, value: Disabled}
- {id: CRC_CGC, value: Disabled}
- {id: DMA_CGC, value: Disabled}
- {id: EWM_CGC, value: Disabled}
- {id: FLEXCAN0_CGC, value: Disabled}
- {id: FLEXCAN1_CGC, value: Disabled}
- {id: FLEXCAN2_CGC, value: Disabled}
- {id: FTFC_CGC, value: Disabled}
- {id: FlexIO0_CGC, value: Disabled}
- {id: 'HSRUN:SCG.DIVBUS.scale', value: '2'}
- {id: 'HSRUN:SCG.DIVCORE.scale', value: '2', locked: true}
- {id: 'HSRUN:SCG.DIVSLOW.scale', value: '3', locked: true}
- {id: 'HSRUN:SCG.SCSSEL.sel', value: SCG.SPLL_CLK}
- {id: LPI2C0_CGC, value: Disabled}
- {id: PCC.ADC0_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
- {id: PCC.ADC1_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
- {id: PCC.FTM0_CLK_SEL.sel, value: SCG.SPLLDIV1_CLK}
- {id: PCC.FTM2_CLK_SEL.sel, value: SCG.SPLLDIV1_CLK}
- {id: PCC.FTM3_CLK_SEL.sel, value: SCG.SPLLDIV1_CLK}
- {id: PCC.LPIT0_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
- {id: PCC.LPSPI0_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
- {id: PCC.LPSPI1_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
- {id: PCC.LPSPI2_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
- {id: PCC.LPTMR0_CLK_SEL.sel, value: NO_CLOCK}
- {id: PCC.LPTMR0_FRAC.scale, value: '1', locked: true}
- {id: PCC.LPUART1_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
...
- {id: 'RUN:SCG.DIVSLOW.scale', value: '3', locked: true}
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    .scgConfig =
    {
        ...
        .soscConfig =
        {
            ...
            .div2 = SCG_ASYNC_CLOCK_DIV_BY_2,     /* System OSC Clock Divider 3: divided by 2 */
        },
        .spllConfig =
        {
            .initialize = true,
